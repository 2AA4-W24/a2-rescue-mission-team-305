...
# [A2] Island ca.mcmaster.se2aa4.island.team305.Explorer
...
- The `ca.mcmaster.se2aa4.island.team_305_.Explorer` class implements the command center, used to compete with the others. (XXX being the team identifier)
